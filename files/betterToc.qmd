    ...
    TRAVERSE [[8397993708429497603]]
        ...
        INSERT {
            ...
            function tocCreateLinkedNotebook(sourceAnchor) {
                ...
                var sourcePageId = currentPageId || (document ? document.idForPage(currentPage) : "");
                _creatingLinkedNotebook = true;

                try {
                    var replyText = linkedNoteBroker.sendSimpleSignal("desktopClipboardCreateLinkedNotebook", "Linked note");
                    console.log("doc-links createLinkedNotebook reply", replyText || "");
                    ...
                    if ((reply.currentDocId && currentDocId && reply.currentDocId !== currentDocId)
                            || (sourceDocId && currentDocId && sourceDocId !== currentDocId)) {
                    ...
                    var targetDocName = reply.targetDocName || "Linked note";
                    var pendingEntry = {
                        targetDocId: reply.targetDocId,
                        targetPageKey: reply.targetPageKey,
                        targetDocName: targetDocName,
                    ...
                    tocNavigateToCrossDoc(xrefKey, reply.targetDocId, reply.targetPageKey);
                } finally {
